...
public class ChineseRestTable {
	...
	public static RestResponse buildResponse(Table table, RestChannel channel) throws Exception {
		...
		XContentType xContentType = XContentType.fromMediaTypeOrFormat(request.param("format", request.header("Content-Type")));
	...
	public static RestResponse buildTextPlainResponse(Table table, RestChannel channel) throws IOException {
		...
		try (BytesStreamOutput bytesOut = channel.bytesOutput(); @SuppressWarnings("resource")
